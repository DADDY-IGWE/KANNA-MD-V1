...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/LORD-IGWE/KANNA-MD-V1';
    ...
    try {
        ...
        const formattedInfo = `*Hello There User! 😄👋* 

> Simple Bot With Amazing Features, Kanna WhatsApp Bot. 🐱

*Thanks for using KANNA MD🫶* 

> Don't forget to star & fork the repo🌟🍴

https://github.com/LORD-IGWE/KANNA-MD-V1
──────────────────
${readMore}
\`BOT NAME:\`🍄
> ${repoData.name}
...
\n> *© POWERED BY CRAZY DEV* 🎐`;
        ...
        await conn.sendMessage(from, {
            image: { url: `https://i.imgur.com/d7LG8tu.jpeg` },
