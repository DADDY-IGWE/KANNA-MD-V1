...
//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/KANNA-CORE/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID
const filer = File.fromURL(`https://mega.nz/file/${sessdata}`)
filer.download((err, data) => {
if(err) throw err
fs.writeFile(__dirname + '/KANNA-CORE/creds.json', data, () => {
...
console.log("CONNECTING KANNA_MD-V1🐱...");
const { state, saveCreds } = await useMultiFileAuthState(__dirname + '/KANNA-CORE/')
...
console.log('♻️ INSTALLING PLUGINS FILES WAIT... 🐱')
const path = require('path');
...
console.log('KANNA_MD-V1 SUCCEFULY CONNECTED🫧')

let up = `*╭──────────────●●►*
> *𝙺𝙰𝙽𝙽𝙰-𝙼𝙳🐱 𝚜𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 𝚌𝚘𝚗𝚗𝚎𝚌𝚝𝚎𝚍 𝚝𝚢𝚙𝚎 .𝚖𝚎𝚗𝚞 𝚝𝚘 𝚜𝚑𝚘𝚠 𝚖𝚢 𝚊𝚕𝚕 𝚌𝚞𝚝𝚎 𝚌𝚖𝚍𝚜 🍄*
...
*╭⊱🐱ＫＡＮＮＡ － ＭＤ🐱⊱╮*
*│ - 📂REPOSITORY NAME:* *KANNA-MD-V1*
*│ - 📃DESCRIPTION:* *simple wha bot🫂*
*│ - 🧠DEV:* *CRAZY-DEV*

*YOUR BOT ACTIVE NOW💫*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `https://i.imgur.com/a8aCPFu.jpeg` }, caption: up })
...
app.get("/", (req, res) => {
res.send("HEY, KANNA-MD-V1 STARTED ✅");
});
